...
sample_script_mvssvd.m is a sample script to run this method


2. mvslra.m implements the method proposed in this paper:
...
sample_script_mvslra.m is a sample script to run this method


3. mvslra_prox.m implements the method proposed in this paper:
...
sample_script_mvslra_prox.m is a sample script to run this method


4. nmi.m computes normalized mutual information (NMI) between two cluster solutions.

5. tbl.m calculates the distribution of values in the given discrete vector.